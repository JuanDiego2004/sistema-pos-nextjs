...
export default function BuscadorClientes({
  ...
  const { clientes, isLoading, error, refetchClientes } = usarClientes();
  ...
  // Función para manejar el registro de un cliente desde el formulario
  const handleClienteRegistrado = () => {
    refetchClientes(); // Recarga los datos desde la API
  };
